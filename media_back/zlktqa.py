...
import config
import sys
sys.path.append(r"C:\Users\admin\Desktop\Flask_Project\Flask_Project\service")
...
def get_data_job():
    ...
    path = "C:/Users/admin/Desktop/Flask_Project/Flask_Project/static/datas/big_media_analysis.csv"
    ...
    path_meida = "C:/Users/admin/Desktop/Flask_Project/Flask_Project/static/datas/media_analysis.csv"
    ...
    path_meida = "C:/Users/admin/Desktop/Flask_Project/Flask_Project/static/datas/reporter_analysis.csv"
    df_media_analysis.to_csv(path_or_buf=path_meida, sep=',', index=False, header=True)
#为实例化的flask引入定时任务配置
